...
public class AladdinCheckersGame {

    public static int aladdinCheckers(String[][] B) {
        int[] MAX = new int[1];
    ...
    public static void dfs(String[][] B, int i, int j, int pawns_beaten, int[] MAX) {
    ...
    public static void main(String[] args) {
        System.out.println(aladdinCheckers(
                new String[][]{{".", ".", "X", ".", ".", "."},
                        {".", ".", ".", ".", ".", "."},
                        {".", ".", ".", ".", "X", "."},
                        {".", "X", ".", ".", ".", "."},
