...
public class AmazonFreshPromotion {
    ...
    public static int willWinPrize(String[][] codeList, String[] shoppingCart) {
    ...
    public static void main(String[] args) {
        System.out.println(willWinPrize(new String[][]{{"apple", "apple"}, {"banana", "anything", "banana"}},
                new String[]{
                        "orange", "apple", "apple", "banana", "orange", "banana"}));

        System.out.println(willWinPrize(new String[][]{{"apple", "apple"}, {"banana", "orange", "banana"}},
        ...
        System.out.println(willWinPrize(new String[][]{{"apple", "apple"}, {"apple", "apple", "banana"}},
